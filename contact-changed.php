...
<script src="js/contactus-changed.js"></script>
</head>
<body>
<?php
...
<div id="contactus" class="panel panel-default box-shadow--6dp">
  <form method="post" action="includes/contactsubmit-changed.php" id="ContactUsForm"><!--action="contactus.php"-->
...
<input type="email" class="form-control" id="inputContactEmail" name="inputContactEmail" maxlength="60" value="<?php echo $contactemail?>"  placeholder="Enter Your Email Address" />
</div><!--/email-->
</div>
...
<textarea class="form-control" id="inputContactMessage" name="inputContactMessage" rows="3" placeholder="Message Here" maxlength="300"><?php if($contactmessage!=''){echo $contactmessage;}?></textarea><br/>
...
<div class="error-message" style="color:red; margin:20px 0"><?php if ($captchaResult=="n") {echo "The security code entered was incorrect. Please try again.";}?></div>
</div>
...
<script>document.write("<script type='text/javascript' src='js/modals2.js?v=" + Date.now() + "'><\/script>");</script>
<script>
